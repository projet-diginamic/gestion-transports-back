...
public class AnnonceCovoiturageController {
	 ...
	 */
	@GetMapping
	public ResponseEntity<List<AnnonceCovoiturageDetailDto>> listerCovoiturages(@RequestParam Integer start,
	...
	public ResponseEntity<List<AnnonceCovoiturageDetailDto>> listerAnnoncesOrgaAvenir(@PathVariable String id)
			throws ListeVideException {
	...
	public ResponseEntity<List<AnnonceCovoiturageDetailDto>> listerAnnoncesOrgaHisto(@PathVariable String id)
			throws ListeVideException {
	 ...
	 */
	@GetMapping("/orga/{id}")
	public ResponseEntity<List<AnnonceCovoiturageDetailDto>> listerAnnoncesOrga(@PathVariable String id)
			throws ListeVideException {
	...
	public ResponseEntity<List<AnnonceCovoiturageDetailDto>> listerAnnoncesOrgaActif(@PathVariable String id)
			throws ListeVideException {
	...
	public ResponseEntity<List<AnnonceCovoiturageDetailDto>> listerAnnoncesOrgaArchive(@PathVariable String id)
			throws ListeVideException {
	...
	public ResponseEntity<List<AnnonceCovoiturageDetailDto>> listerAnnoncesOrgaAnnule(@PathVariable String id)
			throws ListeVideException {
	...
	public ResponseEntity<List<AnnonceCovoiturageDetailDto>> listerAnnoncesOrgaAA(@PathVariable String id)
			throws ListeVideException {
	...
	public ResponseEntity<List<AnnonceCovoiturageDetailDto>> rechercherCovoit(
			@RequestParam(required = false) String date, @RequestParam(required = false) String dep,
